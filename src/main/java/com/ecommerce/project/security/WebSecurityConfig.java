...
//                        .requestMatchers("/api/admin/**").permitAll()
    ...
    // in the above filter chain, we are defining the rules, that is - the APIs will go to spring security & then spring security will decide what to do with that end point
