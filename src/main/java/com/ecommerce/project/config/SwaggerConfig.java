...
public class SwaggerConfig {
   ...
   /*   | Term                     | Simple meaning                                               |
        | ------------------------ | -------------------------------------------------------------|
        |      Security Scheme     | The type of authentication your API uses (JWT bearer token). |
        |   Security Requirement   | Apply this authentication to all endpoints.                  |
        |       Components         | Where Swagger saves your security scheme so it can use it.   |
   */